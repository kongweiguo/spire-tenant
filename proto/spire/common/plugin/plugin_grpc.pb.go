...
func (c *pluginInitClient) Init(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (*InitResponse, error) {
	...
	err := c.cc.Invoke(ctx, PluginInit_Init_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPluginInitServer must be embedded to have
...
func (UnimplementedPluginInitServer) testEmbeddedByValue()                    {}
...
func RegisterPluginInitServer(s grpc.ServiceRegistrar, srv PluginInitServer) {
	// If the following call pancis, it indicates UnimplementedPluginInitServer was
