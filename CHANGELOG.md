...
- Add missing commits to spire-plugin-sdk and spire-api-sdk releases (kongweiguo/spire-api-sdk-tenant#66, spiffe/spire-plugin-sdk#39)
...
- `k8s-workload-registrar` is deprecated in favor of [SPIRE Controller Manager](https://github.com/kongweiguo/spire-tenant-controller-manager) (#3526)
...
- SPIRE Server now implements the [TrustDomain API](https://github.com/kongweiguo/spire-api-sdk-tenant/blob/main/proto/spire/api/server/trustdomain/v1/trustdomain.proto) and related CLI commands (<https://github.com/kongweiguo/spire-tenant/projects/11>)
