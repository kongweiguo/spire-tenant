...
import (
	...
	api "github.com/kongweiguo/spire-api-sdk-tenant/proto/spire/api/server/logger/v1"
	...
	serverlogger "github.com/kongweiguo/spire-tenant/pkg/server/api/logger/v1"
)
