...
import (
	...
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/agent"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/bundle"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/entry"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/federation"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/healthcheck"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/jwt"
	localauthority_jwt "github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/localauthority/jwt"
	localauthority_x509 "github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/localauthority/x509"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/logger"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/run"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/token"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/upstreamauthority"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/validate"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/x509"
	"github.com/kongweiguo/spire-tenant/pkg/common/log"
