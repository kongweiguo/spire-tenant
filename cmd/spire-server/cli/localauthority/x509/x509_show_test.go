...
import (
	...
	authoritycommon_test "github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/authoritycommon/test"
	"github.com/kongweiguo/spire-tenant/cmd/spire-server/cli/localauthority/x509"
