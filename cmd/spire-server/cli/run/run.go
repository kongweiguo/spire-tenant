...
import (
	...
	"github.com/kongweiguo/spire-tenant/pkg/common/config"
	"github.com/kongweiguo/spire-tenant/pkg/common/diskcertmanager"
	"github.com/kongweiguo/spire-tenant/pkg/common/fflag"
	...
	"github.com/kongweiguo/spire-tenant/pkg/server"
	"github.com/kongweiguo/spire-tenant/pkg/server/authpolicy"
	bundleClient "github.com/kongweiguo/spire-tenant/pkg/server/bundle/client"
...
func checkForUnknownConfig(c *Config, l logrus.FieldLogger) (err error) {
	...
	if c.Server != nil {
		...
		// https://github.com/kongweiguo/spire-tenant/issues/1101 for more information
		//
