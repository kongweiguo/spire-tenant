...
import (
	...
	"github.com/kongweiguo/spire-tenant/cmd/spire-agent/cli/api"
	"github.com/kongweiguo/spire-tenant/cmd/spire-agent/cli/healthcheck"
	"github.com/kongweiguo/spire-tenant/cmd/spire-agent/cli/run"
	"github.com/kongweiguo/spire-tenant/cmd/spire-agent/cli/validate"
