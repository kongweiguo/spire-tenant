...
import (
	...
	debugv1 "github.com/kongweiguo/spire-tenant/pkg/agent/api/debug/v1"
	delegatedidentityv1 "github.com/kongweiguo/spire-tenant/pkg/agent/api/delegatedidentity/v1"
