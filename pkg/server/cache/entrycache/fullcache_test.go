...
import (
	...
	sqlds "github.com/kongweiguo/spire-tenant/pkg/server/datastore/sqlstore"
...
func TestFullCacheExcludesNodeSelectorMappedEntriesForExpiredAgents(t *testing.T) {
	...
	// due to stale expired Agent data remaining in the datastore: https://github.com/kongweiguo/spire-tenant/issues/1836
...
// -bench 'BenchmarkBuildSQL' -benchtime <some-reasonable-time-limit> -ldflags "-X github.com/kongweiguo/spire-tenant/pkg/server/cache/entrycache.TestDialect=<mysql|postgres> -X github.com/kongweiguo/spire-tenant/pkg/server/cache/entrycache.TestConnString=<CONNECTION_STRING_HERE> -X github.com/kongweiguo/spire-tenant/pkg/server/cache/entrycache.TestROConnString=<CONNECTION_STRING_HERE>"
