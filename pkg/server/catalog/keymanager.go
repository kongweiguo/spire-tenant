...
import (
	...
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/keymanager/awskms"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/keymanager/azurekeyvault"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/keymanager/disk"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/keymanager/gcpkms"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/keymanager/memory"
)
