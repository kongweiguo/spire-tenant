...
import (
	...
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/bundlepublisher/awsrolesanywhere"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/bundlepublisher/awss3"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/bundlepublisher/gcpcloudstorage"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/bundlepublisher/k8sconfigmap"
)
