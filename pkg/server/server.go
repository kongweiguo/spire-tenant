...
import (
	...
	bundlev1 "github.com/kongweiguo/spire-api-sdk-tenant/proto/spire/api/server/bundle/v1"
	server_util "github.com/kongweiguo/spire-tenant/cmd/spire-server/util"
	"github.com/kongweiguo/spire-tenant/pkg/common/diskutil"
	"github.com/kongweiguo/spire-tenant/pkg/common/health"
	"github.com/kongweiguo/spire-tenant/pkg/common/profiling"
	"github.com/kongweiguo/spire-tenant/pkg/common/telemetry"
	"github.com/kongweiguo/spire-tenant/pkg/common/uptime"
	"github.com/kongweiguo/spire-tenant/pkg/common/util"
	"github.com/kongweiguo/spire-tenant/pkg/common/version"
	"github.com/kongweiguo/spire-tenant/pkg/server/authpolicy"
	bundle_client "github.com/kongweiguo/spire-tenant/pkg/server/bundle/client"
	ds_pubmanager "github.com/kongweiguo/spire-tenant/pkg/server/bundle/datastore"
	"github.com/kongweiguo/spire-tenant/pkg/server/bundle/pubmanager"
	"github.com/kongweiguo/spire-tenant/pkg/server/ca"
	"github.com/kongweiguo/spire-tenant/pkg/server/ca/manager"
	"github.com/kongweiguo/spire-tenant/pkg/server/ca/rotator"
	"github.com/kongweiguo/spire-tenant/pkg/server/catalog"
	"github.com/kongweiguo/spire-tenant/pkg/server/credtemplate"
	"github.com/kongweiguo/spire-tenant/pkg/server/credvalidator"
	"github.com/kongweiguo/spire-tenant/pkg/server/datastore"
	"github.com/kongweiguo/spire-tenant/pkg/server/endpoints"
	"github.com/kongweiguo/spire-tenant/pkg/server/hostservice/agentstore"
	"github.com/kongweiguo/spire-tenant/pkg/server/hostservice/identityprovider"
	"github.com/kongweiguo/spire-tenant/pkg/server/node"
	"github.com/kongweiguo/spire-tenant/pkg/server/plugin/bundlepublisher"
	"github.com/kongweiguo/spire-tenant/pkg/server/registration"
	"github.com/kongweiguo/spire-tenant/pkg/server/svid"
