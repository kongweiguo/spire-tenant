...
[![Build Status](https://github.com/kongweiguo/spire-tenant/actions/workflows/pr_build.yaml/badge.svg)](https://github.com/kongweiguo/spire-tenant/actions/workflows/pr_build.yaml)
[![Go Report Card](https://goreportcard.com/badge/github.com/kongweiguo/spire-tenant)](https://goreportcard.com/report/github.com/kongweiguo/spire-tenant)
...
- Pre-built releases of SPIRE can be found at [https://github.com/kongweiguo/spire-tenant/releases](https://github.com/kongweiguo/spire-tenant/releases). These releases contain both SPIRE Server and SPIRE Agent binaries.
...
- There are several examples demonstrating SPIRE usage in the [spire-examples](https://github.com/kongweiguo/spire-tenant-examples) and [spire-tutorials](https://github.com/kongweiguo/spire-tenant-tutorials) repositories.
...
- See [CONTRIBUTING](https://github.com/kongweiguo/spire-tenant/blob/main/CONTRIBUTING.md) to get started.
- Use [GitHub Issues](https://github.com/kongweiguo/spire-tenant/issues) to request features or file bugs.
