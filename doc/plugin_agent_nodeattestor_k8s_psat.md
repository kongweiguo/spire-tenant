...
A full example of this attestor is provided in [the SPIRE examples repository](https://github.com/kongweiguo/spire-tenant-examples/tree/main/examples/k8s/simple_psat).
