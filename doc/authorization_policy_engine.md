...
| full_method | The full method name of the API call based on the [SPIRE API](https://github.com/kongweiguo/spire-api-sdk-tenant/tree/main/proto/spire/api) | /spire.api.server.svid.v1.SVID/MintJWTSVID |
...
api sdk](https://github.com/kongweiguo/spire-api-sdk-tenant/). Note that it is not
